...
<script type="text/javascript">
	...
	$(function(){
		...
		//（1）点击市场活动按钮后
		//页面加载完毕后触发pageList方法发起AJAX请求
		//默认展开列表的第一页，每页展现两条记录
		pageList(1,2);


		//（3）为查询按钮绑定事件，触发pageList方法
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data.dataList,function (i,n) {
					...
					html += '<td><input type="checkbox" name="xz" value="'+n.id+'"/></td>'; //name="xz" 选择
					html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/activity/detail.do?id='+n.id+'\';">'+n.name+'</a></td>'; //跳转到详细信息页
					html += '<td>'+n.owner+'</td>';
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						<input type="hidden" id="edit-id"/><!-- 隐藏域 -->
						<div class="form-group">
