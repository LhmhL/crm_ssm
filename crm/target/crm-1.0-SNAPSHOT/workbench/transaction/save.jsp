...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="发传单777">
				<input type="hidden" name="activityId" value="36cc154e74894b92992102fdfc0e09f6"/> <!-- 隐藏域 -->
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="512dd0332374485982893e8570be2756"/> <!-- 隐藏域 -->
			</div>
		</div>
		<div class="form-group">
